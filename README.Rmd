...
```{r dtw-comparison, echo=FALSE, fig.width=6}
library("rucrdtw")
set.seed(123)
...
boxplot(benchmark, unit = "ms", log=TRUE, boxwex = 0.5, cex.axis=0.8, medcol = colors, staplecol=colors, boxcol=colors, staplewex=0)
